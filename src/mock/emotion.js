...
export const emotions = [
  { type: 'happy', label: '开心', icon: '/static/emotions/happy.png' },
  { type: 'sad', label: '难过', icon: '/static/emotions/sad.png' },
  { type: 'angry', label: '生气', icon: '/static/emotions/angry.png' },
  { type: 'anxious', label: '焦虑', icon: '/static/emotions/anxious.png' },
  { type: 'neutral', label: '平静', icon: '/static/emotions/neutral.png' }
];
