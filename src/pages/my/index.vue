...
async function getUser() {
	// 使用 mock 数据来模拟返回
	console.log("query user data: ", mockUser);
	meStore.$patch({ user: mockUser });
}
...
function toRankList(option) {
	uni.navigateTo({
		url: `/pages/my/rankList?option=${option}`,
	});
}
